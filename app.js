...
// APP.JS — RESTORED STABLE FULL VERSION
// ======================================================
    ...
    event => {
      ...
      if (lessonListItem) {
        ...
        openLesson(
          ...
          lessonListItem.dataset.course,

          Number(
            lessonListItem.dataset.lessonIndex
          )
